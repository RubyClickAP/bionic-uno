...
function showClientProfiles(clientId) {
	$.ajax({
		url: '/admin/clients/'+clientId+'/profiles',
		type: 'GET',
		dataType: 'html',
		success: function(data) {
			$('#client_details').html(data);
...
function showClientVideos(clientId) {
	$.ajax({
		url: '/admin/clients/'+clientId+'/videos',
		type: 'GET',
		dataType: 'html',
		success: function(data) {
			$('#client_details').html(data);
...
// DELETE /clients/id/video
function deleteVideo(clientId, videoId) {
  //console.log("clientId: " + clientId + ", videoId: " + videoId);
	if(confirm("Video " + videoId + " will be remove, Are you sure?")) {
		$.ajax({
	      url: '/admin/clients/' + clientId + '/videos/' + videoId,
	      type: 'DELETE',
	      dataType: 'json',
	      success: function(data) {
					$('li#video_'+videoId).remove();
					showSuccess("Video successfully removed.")
	      },
	  });
	}
	return false;
